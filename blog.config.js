...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '美好生活', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享+购物', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.696980.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '购物, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '这里是美好生活频道，分享好玩的网站和软件，还有实惠购物,欢迎来到我的博客',
